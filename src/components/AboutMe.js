...
export default function AboutMe ()
{
  ...
  return (
    <section id="about-me" className="parallax fade-in-out text-center">
      ...
      <motion.h1
        className="text-3xl small:text-4xl md:text-5xl font-extrabold flex justify-center text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"
      >
      ...
      >
        ...
        >
          I am <span className="text-purple-400 font-semibold">Shramana Sinha</span>,
          a passionate and versatile Data Science and Programming undergraduate with
          a strong foundation in Machine Learning, Artificial Intelligence, and Web Development.
        </motion.p>
        ...
        >
          I am adept at designing and deploying efficient software solutions while
          exploring innovative AI applications. I am seeking research-focused opportunities
          to contribute to cutting-edge advancements in AI/ML, leveraging academic expertise

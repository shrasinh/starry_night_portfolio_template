...
import { FaVuejs, FaBootstrap, FaGithub } from 'react-icons/fa';
...
export default function SkillsChart ( { activeSection } )
{
    ...
    return (
        <section id="skills" className="parallax fade-in-out text-center">
            <motion.h1
                className="text-3xl small:text-4xl md:text-5xl font-extrabold flex justify-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"
            >
                ...
                { selectedProject && (
                    ...
                    >
                        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                            ...
                            <motion.div
                                className="relative z-[125] inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                                role="dialog"
                                aria-modal="true"
                            ...
                            >
                                <div className="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div className="sm:flex sm:items-start">
                                        <button onClick={ handleCloseModal } className="absolute top-4 right-4 text-gray-400 hover:text-white transition-colors duration-200 text-2xl" aria-label="Close modal"> ✖</button>
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            <h3 className="text-3xl font-bold mb-4 text-white" id="modal-headline">
